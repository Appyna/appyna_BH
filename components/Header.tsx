...
export const Header: React.FC = () => {
  ...
  return (
    <>
    <header className={`bg-white/95 backdrop-blur-lg shadow-lg fixed md:sticky top-0 w-full z-40 border-b border-purple-100 transition-transform duration-300 md:translate-y-0 ${isHeaderVisible ? 'translate-y-0' : '-translate-y-full md:translate-y-0'}`}>
